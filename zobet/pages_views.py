...
def faq_view(request):
    faqs = [
        ...
        {'q': 'How is the prize distributed?', 'a': 'When the admin declares a winner, the platform commission is deducted from the total pool. The remaining amount is split equally among all users who predicted the correct champion.'},
        ...
        {'q': 'Is there a minimum withdrawal amount?', 'a': 'Yes, the minimum withdrawal amount is ₹100. There is no minimum deposit amount.'},
